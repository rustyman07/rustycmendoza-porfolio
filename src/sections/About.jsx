  ...
  return (
    ...
    >
      <div className="sec-content-wrapper ">
        ...
        <div
          ref={aboutCardRef}
          className={`main-card max-w-[900px] w-full m-auto  relative px-5`}
        >
          <div
          ...
          >
            ...
            >
              ...
              <div
                ref={textRef}
                className="right font-thin sm:w-[60%] w-full md:p-12 px-5  lg:pt-[70px] pb-5 pt-8 sm:text-base text-sm relative"
              >
